  ...
  return (
    <Section>
      <h1 className="text-5xl font-extrabold leading-snug">
        Hi, I'm
        <br />
        <span className="px-1 italic">Francisco Cabot</span>
      </h1>
      <motion.p
      ...
      >
        I'm a front-end developer based in China.
        <br />
        This website's is inspired by{' '}
        <a className="text-indigo-600 underline" href="https://github.com/wass08">
          Wawa Sensei
        </a>
        <br />
        This repository is forked from{' '}
        <a className="text-indigo-600 underline" href="https://github.com/wass08/r3f-portfolio-final">
          r3f-portfolio-final
        </a>
        <br />
        and I'm trying to learn from his tutorial
        <br />
        to customize my portfolio website
      </motion.p>
      <motion.button
